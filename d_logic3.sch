...
N -1080 -530 -1000 -530 { lab=#net11}
N -1080 -510 -1000 -510 { lab=#net12}
N -920 -530 -900 -530 { lab=#net13}
N -920 -510 -900 -510 { lab=#net14}
N -820 -530 -680 -530 { lab=outp}
N -820 -510 -680 -510 { lab=outn}
N 1350 -330 1370 -330 { lab=#net15}
N 1450 -330 1590 -330 { lab=creset}
...
C {vsource.sym} -30 -120 0 0 {name=V7 value="pulse(0 1.8 1p 1p 1p 100n 200n)"
}
...
C {vsource.sym} -360 20 0 0 {name=V3 value="pwl(0 0.89999 203.2n 0.89999 203.5n 0.90001 )"
}
C {gnd.sym} -360 50 0 0 {name=l3 lab=GND}
C {vsource.sym} -130 30 0 0 {name=V4 value="pwl(0 0.90001 203.2n 0.90001 203.5n 0.89999 )"
...
C {lab_pin.sym} 1590 -330 2 0 {name=l49 sig_type=std_logic lab=creset}
...
C {lab_pin.sym} -680 -530 2 0 {name=l52 sig_type=std_logic lab=outp}
C {lab_pin.sym} -680 -510 2 0 {name=l53 sig_type=std_logic lab=outn}
...
C {xschem_sky130/sky130_stdcells/inv_1.sym} -960 -530 0 0 {name=x18 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/inv_1.sym} -960 -510 0 0 {name=x19 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/inv_1.sym} -860 -510 0 0 {name=x20 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/inv_1.sym} -860 -530 0 0 {name=x21 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/inv_1.sym} 1310 -330 0 0 {name=x22 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/inv_1.sym} 1410 -330 0 0 {name=x25 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
