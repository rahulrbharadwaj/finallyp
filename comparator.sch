...
N -80 -310 -60 -310 { lab=GND}
N 50 -310 70 -310 { lab=GND}
...
N -10 -200 20 -200 { lab=GND}
N 20 -200 20 -170 { lab=GND}
N -10 -170 20 -170 { lab=GND}
...
C {gnd.sym} 50 -390 3 0 {name=l8 lab=GND}
C {gnd.sym} -80 -390 3 0 {name=l9 lab=GND}
C {gnd.sym} -60 -310 3 0 {name=l10 lab=GND}
C {gnd.sym} 70 -310 3 0 {name=l11 lab=GND}
C {vsource.sym} -160 -650 0 0 {name=V1 value="pulse(0 1.0 1ps 1.9ns 0.1ns 0.1ns 2ns)"}
...
C {vsource.sym} 230 -630 0 0 {name=V3 value="pwl(0 0.8991210375 2.9n 0.8991210375 3.0n 0.90087890625 4.9n 0.90087890625 5.0n 0.8991210375)"}
C {gnd.sym} 230 -600 0 0 {name=l16 lab=GND}
C {vsource.sym} 370 -630 0 0 {name=V4 value="pwl(0 0.90087890625 1.6n 0.90087890625 1.7n 0.8991210375 3.6n 0.8991210375 3.7n 0.90087890625)"
}
C {gnd.sym} 370 -600 0 0 {name=l18 lab=GND}
C {lab_pin.sym} 370 -660 0 0 {name=l17 sig_type=std_logic lab=vip
}
