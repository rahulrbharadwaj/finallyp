...
C {xschem_sky130/sky130_stdcells/bufbuf_16.sym} 2040 -1310 0 0 {name=x3 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/bufbuf_16.sym} 2120 -1310 0 0 {name=x4 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/bufbuf_16.sym} 2200 -1310 0 0 {name=x5 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/bufbuf_16.sym} 2280 -1310 0 0 {name=x6 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/bufbuf_16.sym} 2360 -1310 0 0 {name=x7 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/bufbuf_16.sym} 2440 -1310 0 0 {name=x8 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/bufbuf_16.sym} 2520 -1310 0 0 {name=x9 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/bufbuf_16.sym} 2600 -1310 0 0 {name=x10 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/bufbuf_16.sym} 2680 -1310 0 0 {name=x11 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/bufbuf_16.sym} 2760 -1310 0 0 {name=x12 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
...
C {/home/cegrahul/Desktop/fyp/cdac.sym} 1710 -1620 0 0 {name=x17}
C {lab_pin.sym} 1560 -1450 0 0 {name=l53 sig_type=std_logic lab=to_analog12}
C {lab_pin.sym} 1560 -1470 0 0 {name=l54 sig_type=std_logic lab=to_analog11}
C {lab_pin.sym} 1560 -1490 0 0 {name=l55 sig_type=std_logic lab=to_analog10}
C {lab_pin.sym} 1560 -1430 0 0 {name=l56 sig_type=std_logic lab=to_analog17}
...
C {lab_pin.sym} 1560 -1690 0 0 {name=l65 sig_type=std_logic lab=to_analog8}
C {lab_pin.sym} 1560 -1670 0 0 {name=l66 sig_type=std_logic lab=to_analog9}
C {lab_pin.sym} 1560 -1650 0 0 {name=l68 sig_type=std_logic lab=to_analog5}
C {lab_pin.sym} 1560 -1770 0 0 {name=l69 sig_type=std_logic lab=to_analog7
}
C {lab_pin.sym} 1560 -1790 0 0 {name=l70 sig_type=std_logic lab=to_analog4
}
C {lab_pin.sym} 1560 -1710 0 0 {name=l71 sig_type=std_logic lab=to_analog3}
C {lab_pin.sym} 1560 -1530 0 0 {name=l61 sig_type=std_logic lab=to_analog18}
C {lab_pin.sym} 1560 -1510 0 0 {name=l72 sig_type=std_logic lab=vinn}
C {lab_pin.sym} 1560 -1630 0 0 {name=l73 sig_type=std_logic lab=vinp}
C {lab_pin.sym} 1560 -1830 0 0 {name=l75 sig_type=std_logic lab=clksb}
C {lab_pin.sym} 1560 -1410 0 0 {name=l76 sig_type=std_logic lab=clks}
