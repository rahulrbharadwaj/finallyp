...
N -850 -640 -830 -640 { lab=outp}
N -850 -490 -830 -490 { lab=outn}
N -830 -640 -780 -640 { lab=outp}
N -780 -640 -780 -560 { lab=outp}
N -830 -490 -780 -490 { lab=outn}
N -780 -520 -780 -490 { lab=outn}
N -660 -540 -630 -540 { lab=valid}
...
.tran 1n 1u
.save mclk creset clks clksb valid outp outn clk10
...
C {vsource.sym} -360 20 0 0 {name=V3 value="pulse(-1.8 1.8 1p 1p 1p 10n 20n)"
}
C {gnd.sym} -360 50 0 0 {name=l3 lab=GND}
C {vsource.sym} -130 30 0 0 {name=V4 value=1.8
}
...
C {lab_pin.sym} -140 -150 0 0 {name=l9 sig_type=std_logic lab=vdd}
C {lab_pin.sym} -30 -150 0 0 {name=l10 sig_type=std_logic lab=mclk}
C {lab_pin.sym} -360 -10 0 0 {name=l12 sig_type=std_logic lab=outp}
C {lab_pin.sym} -130 0 0 0 {name=l13 sig_type=std_logic lab=outn}
...
C {xschem_sky130/sky130_stdcells/nand2_1.sym} -720 -540 0 0 {name=x14 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {lab_pin.sym} -850 -640 0 0 {name=l5 sig_type=std_logic lab=outp}
C {lab_pin.sym} -850 -490 0 0 {name=l8 sig_type=std_logic lab=outn}
C {lab_pin.sym} -630 -540 2 0 {name=l36 sig_type=std_logic lab=valid}
C {vsource.sym} -670 -40 0 0 {name=V1 value=-1.8}
C {vsource.sym} -600 -50 0 0 {name=V5 value=-1.8
}
C {vsource.sym} -520 -50 0 0 {name=V6 value=1.8}
C {vsource.sym} -440 -50 0 0 {name=V8 value=1.8
}
C {gnd.sym} -670 -10 0 0 {name=l38 lab=GND}
C {gnd.sym} -600 -20 0 0 {name=l39 lab=GND}
C {gnd.sym} -520 -20 0 0 {name=l40 lab=GND}
C {gnd.sym} -440 -20 0 0 {name=l41 lab=GND}
C {lab_pin.sym} -670 -70 0 0 {name=l42 sig_type=std_logic lab=VGND}
C {lab_pin.sym} -600 -80 0 0 {name=l43 sig_type=std_logic lab=VNB}
C {lab_pin.sym} -520 -80 0 0 {name=l44 sig_type=std_logic lab=VPB}
C {lab_pin.sym} -440 -80 0 0 {name=l45 sig_type=std_logic lab=VPWR}
...
C {xschem_sky130/sky130_stdcells/or3_1.sym} 1210 -330 0 0 {name=x16 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
C {xschem_sky130/sky130_stdcells/inv_8.sym} 70 -260 0 0 {name=x15 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
